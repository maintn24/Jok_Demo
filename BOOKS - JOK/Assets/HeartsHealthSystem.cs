...
public class HeartsHealthSystem
{
    ...
    {
        //Clycle through all hearts starting from the end
        for (int i = heartList.Count - 1; i >= 0; i--)
        {
            ...
            {
                //Heart cannot absorb damageAmount, damage heart and keep going to next heart
    ...
    public void Heal(int healAmount)
    {
        ...
        if (OnHealed != null) OnDamaged(this, EventArgs.Empty);
    }
